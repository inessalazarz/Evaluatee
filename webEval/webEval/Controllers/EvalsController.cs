...
namespace webEval.Controllers
{
    public class EvalsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentId,Name,BirthDate,Type")] Eval eval)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentId,Name,BirthDate,Type")] Eval eval)
        {
            if (ModelState.IsValid)
            {
